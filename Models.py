...
class DisplacementNet(nn.Module):
    def __init__(self):
        ...
        #self.layer2_conv =nn.Sequential(nn.BatchNorm2d(num_features=2), nn.Conv2d(in_channels=2, out_channels=1, kernel_size=(1,1)))
        ...
        #self.layer2_conv[1].bias = nn.Parameter(self.layer2_conv[1].bias.abs())

        #self.layer0_conv.weight = nn.Parameter(self.layer0_conv.weight.abs())
        #self.layer2_conv.weight = nn.Parameter(self.layer2_conv.weight.abs())
